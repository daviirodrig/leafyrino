...
#define MyAppName "Leafyrino"
#define MyAppVersion "2.5.5"
#define MyAppPublisher "Leafyzito"
#define MyAppURL "https://github.com/Leafyzito/leafyrino"
#define MyAppExeName "Leafyrino.exe"
#define MyAppProductName "Leafyrino"
#define MyAppDescription "Leafyrino Installer"
#define MyAppCopyright "Copyright (C) Leafyzito"
...
VersionInfoOriginalFileName=Leafyrino Updater.exe
...
#else
OutputBaseFilename=Leafyrino.Installer
#endif
#ifdef SETUP_ICON_FILE
...
[Files]
Source: "{#WORKING_DIR}{#STAGING_DIR_NAME}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#WORKING_DIR}vc_redist.{#VCRT_ARCH}.exe"; DestDir: "{tmp}"; Tasks: vcredist;
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "Leafyzito.Leafyrino"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "Leafyzito.Leafyrino"; Tasks: desktopicon
